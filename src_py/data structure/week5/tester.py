...
# dictionary is a simple python list of words

document = load_doc_words("trgov.txt")
...
# the raw dicionary (ie the simple list of words in the dictionary) to do it's checking

#check_time = spellcheck_with_list(document, dictionary)
...
#check_time = spellcheck_with_hashtable(document, dictionary, 'Chaining', 11)
#check_time = spellcheck_with_hashtable(document, dictionary, 'Chaining', 800011)
#check_time = spellcheck_with_hashtable(document, dictionary, 'Linear', 2000003)
#check_time = spellcheck_with_hashtable(document, dictionary, 'Quadratic', 800011)
...
# spellcheck_with_hashtable(document, dictionary, 'Quadratic', 800011, quiet_mode=True)
